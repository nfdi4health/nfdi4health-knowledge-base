...
1. Go to the [NFDI4Health Knowledge Base repo](https://github.com/nfdi4health/nfdi4health-knowledge-base) on GitHub.
...
3. Discuss your idea with the editors through comments in the issues – you will be notified when others comment.
    ...
    * You can always return to your opened issue by going to the [issues section](https://github.com/nfdi4health/nfdi4health-knowledge-base/issues) of our GitHub repo.

{% include callout.html type="tip" content="You can also get to the [NFDI4Health Knowledge Base](https://github.com/nfdi4health/nfdi4health-knowledge-base) repo on GitHub using the 'GitHub' link in the header of this site." %}
...
3. We use markdown. To learn how to create paragraphs, headings, format text, add links and images and much more, follow our [markdown cheat sheet](markdown_cheat_sheet).
...
* If you want to list training material or link to other pages, add it to the page metadata. Read more on how to do this in our [page metadata guide](page_metadata).

{% include callout.html type="important" content="In general terms, you must avoid manual interlinking of pages." %}
...
3. Create a pull request following [GitHub's documentation](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request)
    {% include image.html file="draft_pullrequest_github.png" inline=true alt="Draft pull request on GitHub" %}
...
{% include callout.html type="tip" content="You can return to your pull request by going to the [pull request section](https://github.com/nfdi4health/nfdi4health-knowledge-base/pulls) of our GitHub repo." %}
...
1. Go to your pull request. You can return to it by going to the [pull request section](https://github.com/nfdi4health/nfdi4health-knowledge-base/pulls) of our GitHub repo
2. Click on "Files changed" in the top menu bar, then click the "..." icon of the file you want to edit and select "Edit file". Make your changes, then click "Commit changes".
...
When all requests have been addressed, the editors will mark the conversation as "Resolved" and the proposed changes as "Approved" — your content is then ready to be published.

{% include callout.html type="tip" content="You can also edit your pull request any time before it's merged, if you change your mind about anything." %}
